...
/***/ function(module, exports, __webpack_require__) {
	...
	var dj = function () {
	    var player1, player2;
	    function init() {
	        this.player1 = new _player2.default($("#player1"), $("#tempo1"), $("#bpm1"));
	        this.player2 = new _player2.default($("#player2"), $("#tempo2"), $("#bpm2"));
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _analyzer = __webpack_require__(301);
	
	var _analyzer2 = _interopRequireDefault(_analyzer);
	
	var _kali = __webpack_require__(302);
	
	var _kali2 = _interopRequireDefault(_kali);
	...
	var wavesurfer = __webpack_require__(305);
	var soundcloud = __webpack_require__(306);
	
	var clientId = "62bdfd1ba23c2ef7491219c96aff2e14";
	soundcloud.initialize({ client_id: clientId });
	
	var Player = function () {
	    function Player(container, slider, bpmContainer) {
	        _classCallCheck(this, Player);
	
	        var self = this;
	
	        this.drawer = new _drawer2.default(container);
	        ...
	        this.analyzer = new _analyzer2.default();
...
/***/ function(module, exports) {
	...
	var Analyzer = function () {
	    ...
	    _createClass(Analyzer, [{
	        key: "analyze",
	        value: function analyze(backend, callback) {
	            this.prepare(backend.buffer, callback);
	        }
	    }, {
	        key: "prepare",
	        value: function prepare(buffer, callback) {
	        ...
	        key: "process",
	        value: function process(e, callback) {
	        ...
	        key: "countIntervalsBetweenNearbyPeaks",
	        value: function countIntervalsBetweenNearbyPeaks(peaks) {
	            var intervalCounts = [];
	        ...
	        key: "groupNeighborsByTempo",
	        value: function groupNeighborsByTempo(intervalCounts) {
	            var tempoCounts = [];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Drawer = function Drawer(container) {
